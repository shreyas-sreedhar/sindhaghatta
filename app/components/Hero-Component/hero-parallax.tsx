...
export const Header = () => {
  return ( <> 
    ...
    <div className="max-w-7xl relative mx-auto py-20 md:py-20 px-4 w-full  left-0 top-0">
      <h1 className="text-2xl md:text-7xl font-bold z-20 bg-clip-text bg-gradient-to-b from-neutral-200 to-neutral-500 py-8 dark:text-white">
     Sindhughatta Grama Devathe
      </h1>
